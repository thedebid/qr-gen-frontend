...
export default function UpdateAddress() {
  ...
  const onSubmit = async (data) => {
    http
      ...
      .then((response) => {
        // console.log(response.data.isAddressUpdated);
    ...
    <section className="login">
      <div className="login-grid">
        ...
        <div className="login-right">
          ...
          <div className="w-100">
            <small className="mt-2">Enter your billing address.</small>
            <form className="w-100" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="form-group mt-3">
                <label htmlFor="password">Local Address</label>
                <input
                  type="password"
                  className="form-control "
                  id="password"
              ...
              <a href="#/forgot-password">
                <small
                  id="emailHelp"
                  className="form-text text-primary text-right"
                >
                  Forgot Password?
                </small>
              </a>
